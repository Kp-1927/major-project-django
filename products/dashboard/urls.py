...
urlpatterns = [
   ...
   path("product-create-api-view/", DashboardProductModelCreateAPIView.as_view(), name="DashboardProductModelCreateAPIView"),
    ...
    path("product-main-model-list-api-view/", DashboardProductMainModelListAPI.as_view(), name="DashboardProductMainModelListAPIView"),
]